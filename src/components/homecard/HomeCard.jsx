...
const HomeCard = () => {
  ...
  return (
    ...
    return (
      ...
      background:currentTheme.palette.type === 'light'
      ? "#fff"
      : "#1E1E1E",
      }}>
      ...
      <CardContent>
        ...
        fontFamily:"raleWay" , fontWeight:"600"}} >{card.title} </Typography>
        <Typography sx={{ 
         color: currentTheme.palette.type === 'light'? "#1e1e1e" : "#ffff",        
        fontFamily:"raleWay" , fontWeight:"300" , fontSize:"13px"}} >{card.small} </Typography>
      </CardContent>
      </Link>
      </Card>
